...
static Key keys[] = {
	...
	{ MODKEY,                       XK_F2,     spawn, SHCMD("pamixer -u ; pamixer --allow-boost -d 5; kill -44 $(pidof dwmblocks)")  },
	{ MODKEY,                       XK_F3,     spawn, SHCMD("pamixer -u ; pamixer --allow-boost -i 5; kill -44 $(pidof dwmblocks)")  },
	...
	{ MODKEY,			XK_F11,    spawn,          {.v = brdown  } },
	{ MODKEY,			XK_F12,    spawn,          {.v = brup	} },
